...
import { hideErrorElements, hideSuccessElements } from "../../Utils/useHelpers";
...
const Register = () => {
  ...
  const { user, auth, loading, handleGoogleSignIn, registerUser } =
        ...
        <div className="border p-6 rounded-md shadow-lg bg-base-200">
          ...
          <form onSubmit={handleRegister} className="w-full space-y-2">
            ...
            <div className="">
              ...
              <Link
                to="/login"
                className="text-xs hover:underline text-indigo-500"
              >
                Login
              </Link>
            </div>
